...
func new_dialogue_sequence(position: Vector2, lines: Array[String], colour:String, linger_time:float=2, follow_node:CanvasItem = null, skippable:bool=true) -> DialogueSequence:
